-- =============================================================
-- Fleet Management - TENANT SCHEMA TEMPLATE (Fleet data)
-- For multi-tenant mode: import into each tenant DB (fm_tenant_<companyId>)
-- Remove CREATE DATABASE if DB already selected in phpMyAdmin.
-- =============================================================
-- Example DB name to create manually: fm_tenant_1
-- CREATE DATABASE IF NOT EXISTS fm_tenant_1 CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
-- USE fm_tenant_1;
