...
<div class="container-fluid mt-4">
    <div class="row mb-4">
        <div class="col-md-6">
            <h2><i class="fas fa-user-plus"></i> Adaugă Mecanic Nou</h2>
        </div>
            ...
            <form method="POST">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="specialization" name="specialization" placeholder="ex: Mecanic Auto General, Electrician Auto">
                        </div>
                        
                        <div class="mb-3">
                            <label for="hire_date" class="form-label">Data Angajare</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="phone" name="phone" placeholder="ex: 0740123456">
                        </div>
                        
                        <div class="mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input type="email" class="form-control" id="email" name="email" placeholder="ex: mecanic@email.com">
                        </div>
                        
                        <div class="mb-3">
                            <label for="hourly_rate" class="form-label">Tarif Orar (RON)</label>
                            <input type="number" class="form-control" id="hourly_rate" name="hourly_rate" step="0.01" value="<?= $service['hourly_rate'] ?? 150 ?>">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Salvează Mecanic
                    </button>
                </div>
            </form>
        </div>
